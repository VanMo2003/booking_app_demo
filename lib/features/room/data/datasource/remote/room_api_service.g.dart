...
class _RoomApiService implements RoomApiService {
  _RoomApiService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<ApiResponse> getRoomById(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<ApiResponse> createRoom(RoomCreateDto body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<ApiResponse> updateRoom(int id, RoomUpdateDto body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
