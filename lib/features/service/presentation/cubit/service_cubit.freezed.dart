...
mixin _$ServiceState {
  ...
  List<ServiceEntity>? get items => throw _privateConstructorUsedError;
...
abstract class $ServiceStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {ServiceStatus status, List<ServiceEntity>? items, String? errorMessage});
}
...
class _$ServiceStateImpl implements _ServiceState {
  ...
  final List<ServiceEntity>? _items;
  @override
  List<ServiceEntity>? get items {
    final value = _items;
  ...
  @override
  String toString() {
    return 'ServiceState(status: $status, items: $items, errorMessage: $errorMessage)';
  }
...
abstract class _ServiceState implements ServiceState {
  const factory _ServiceState(
      {final ServiceStatus status,
      final List<ServiceEntity>? items,
      final String? errorMessage}) = _$ServiceStateImpl;
