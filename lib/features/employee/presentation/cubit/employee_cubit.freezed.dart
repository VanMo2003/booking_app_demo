...
abstract class $EmployeeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {EmployeeStatus status, List<Employee>? employees, String? errorMessage});
}
...
class _$InitialImpl implements _Initial {
  ...
  @override
  String toString() {
    return 'EmployeeState(status: $status, employees: $employees, errorMessage: $errorMessage)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, status,
      const DeepCollectionEquality().hash(_employees), errorMessage);
