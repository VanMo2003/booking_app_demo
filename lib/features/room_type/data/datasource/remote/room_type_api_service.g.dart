...
part of 'room_type_api_service.dart';
...
class _RoomTypeApiService implements RoomTypeApiService {
  _RoomTypeApiService(this._dio, {this.baseUrl, this.errorLogger});
  ...
  @override
  Future<ApiResponse> getRoomTypes() async {
  ...
  @override
  Future<ApiResponse> deleteRoomType(int id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
